...
def generate_launch_description():
    ...
    return LaunchDescription([
        # IncLaunch(PyLaunch([this_launch_pkg, '/launch/detector/yolox_example/detector_bringup.launch.py'])),
        IncLaunch(PyLaunch([this_launch_pkg, '/launch/detector/panel/panel_bringup.launch.py'])),
